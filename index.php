...
.mobile-reservar{margin-top:20px;margin-bottom:32px;opacity:0;transform:translateX(-14px);transition:opacity var(--dur-base) var(--ease-out),transform var(--dur-base) var(--ease-out);transition-delay:.24s}
...
<section class="sec" id="cocina">
  <div class="wrap">
    ...
    <div class="dishes">
      <article class="dish">
        <div class="ph" data-note="foto: escanciado de sidra"><img src="assets/img/logo-horizontal-verde.png" alt=""></div>
      ...
      <article class="dish">
        <div class="ph" data-note="foto: cachopo al corte"><img src="assets/img/logo-horizontal-verde.png" alt=""></div>
      ...
      <article class="dish">
        <div class="ph" data-note="foto: fabada en pote"><img src="assets/img/logo-horizontal-verde.png" alt=""></div>
